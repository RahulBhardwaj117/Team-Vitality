...
from schemas.prediction_schemas import WeatherRequest, WeatherResponse, WeeklyWeatherResponse
...
async def get_weekly_weather(start_date: Optional[date] = None):
    """
    Get 7-day forecast starting from start_date (defaults to today)
    """
