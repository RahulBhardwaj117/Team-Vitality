...
DATA_FILE = os.path.join(BASE_DIR, "ground_water.csv")
MODEL_FILE = os.path.join(BASE_DIR, "groundwater_model.pkl")
SCALER_FILE = os.path.join(BASE_DIR, "groundwater_scaler.pkl")
FEATURES_FILE = os.path.join(BASE_DIR, "groundwater_features.json")
