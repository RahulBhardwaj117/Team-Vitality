...
MODEL_FILE = os.path.join(SCRIPT_DIR, "drought_model.pkl")
SCALER_FILE = os.path.join(SCRIPT_DIR, "drought_scaler.pkl")
FEATURES_FILE = os.path.join(SCRIPT_DIR, "drought_features.json")
WEATHER_FILE = os.path.join(SCRIPT_DIR, "final_weather.csv")
RAIN_FILE = os.path.join(SCRIPT_DIR, "delhi-monthly-rains.csv")
...
weather_db = pd.read_csv(WEATHER_FILE)
...
monthly_rain = pd.read_csv(RAIN_FILE)
