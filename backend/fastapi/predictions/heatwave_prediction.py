...
MODEL_FILE = os.path.join(SCRIPT_DIR, "heatwave_model_ensemble.pkl")
SCALER_FILE = os.path.join(SCRIPT_DIR, "heatwave_scaler.pkl")
FEATURES_FILE = os.path.join(SCRIPT_DIR, "heatwave_features.json")
DATA_FILE = os.path.join(SCRIPT_DIR, "weatherdata.csv")
NORMALS_FILE = os.path.join(SCRIPT_DIR, "delhi-temperature.csv")
