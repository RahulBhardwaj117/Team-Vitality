...
# Path configuration - point to models and data directories
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.model_paths = {
                "flood": {
                    "model": os.path.join(MODELS_DIR, "flood_xgboost_balanced.pkl"),
                    "scaler": os.path.join(MODELS_DIR, "flood_scaler_balanced.pkl"),
                    "features": os.path.join(MODELS_DIR, "flood_features_balanced.json")
                },
                "drought": {
                    "model": os.path.join(MODELS_DIR, "drought_model.pkl"),
                    "scaler": os.path.join(MODELS_DIR, "drought_scaler.pkl"),
                    "features": os.path.join(MODELS_DIR, "drought_features.json")
                },
                "heatwave": {
                    "model": os.path.join(MODELS_DIR, "heatwave_model_ensemble.pkl"),
                    "scaler": os.path.join(MODELS_DIR, "heatwave_scaler.pkl"),
                    "features": os.path.join(MODELS_DIR, "heatwave_features.json")
                },
                "groundwater": {
                    "model": os.path.join(MODELS_DIR, "groundwater_model.pkl"),
                    "scaler": os.path.join(MODELS_DIR, "groundwater_scaler.pkl")
                },
                "weather": {
                    "data": os.path.join(DATA_DIR, "final_weather.csv")
                }
            }
